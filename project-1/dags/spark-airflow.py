...
clean_data = BashOperator(
    task_id="clean_data",
    bash_command="spark-submit --master spark://spark:7077 /opt/spark-apps/clean_data.py",
    dag=dag,
)
...
transform_data = BashOperator(
    ...
    bash_command="spark-submit --master spark://spark:7077 /opt/spark-apps/transform_data.py",
    dag=dag,
)
